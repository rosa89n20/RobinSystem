...
[Serializable] //NOTE TO SELF- THERE NEEDS TO BE 2 DIFF VERSIONS OF THIS SCRIPT FOR DFGUI
public class GAC_SyncSetup{
	...
	//FOR DFGUI USE//
	public bool useDFGUI; //Triggers to check when DFGUI input method is chosen
